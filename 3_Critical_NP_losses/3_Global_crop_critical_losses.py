...
ds_Crop_N_input = ds_Crop_N_input_all.sel(time = "2015-05-01")
...
ds_Grass_N_input = ds_Grass_N_input_all.sel(time = "2015-05-01")
...
ds_Crop_P_input = ds_Crop_P_input_all.sel(time = "2015-05-01")
...
ds_Grass_P_input = ds_Grass_P_input_all.sel(time = "2015-05-01")
